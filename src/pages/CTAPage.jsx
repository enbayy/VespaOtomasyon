...
const SecuritySection = () => {
    return (
        <section className="bg-[#af1816] text-white text-center py-16 px-6 md:px-20 space-y-8">
            ...
            <button style={{ fontFamily: "Inter, sans-serif" }} data-aos="fade-up" data-aos-delay="500" className="bg-white text-[#af1816] font-semibold px-6 py-3 rounded-lg shadow-xl hover:bg-gray-100 transition transform hover:scale-105">
                HEMEN BİLGİ AL
            </button>
        </section>
    );
